    ...
    if ($result->num_rows === 1) {
        ...
        if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["delAcc"])) {
            ...
            if (password_verify($password, $pass)) {
                $selectUserSql = "SELECT user_id FROM users WHERE username = '$username'";
                ...
                if ($userResult->num_rows > 0) {
                    ...
                    $updateAlumniSql = "UPDATE alumni SET user_id = NULL, approved = NULL WHERE user_id = $user_id";
                    $updateAlumniResult = $conn->query($updateAlumniSql);
            
                    if ($updateAlumniResult === TRUE) {
                    ...
                    $_SESSION['user_stat'] = "Account not found.";
                    echo "<script>
                        window.location.href = 'account-settings.php'; 
                    </script>";
                }
                ...
                <div class="modal-body">
                    ...
                    <div class="">
                        ...
                        <div class="input-group">
                            <input type="password" class="form-control z-0 aa" id="passw4" name="password">
